package com.devoir.pokedex.ui.activity;
...
import com.devoir.pokedex.R;
import com.devoir.pokedex.pokedex.api.PokedexApiService;
import com.devoir.pokedex.pokedex.api.PokedexRetrofitResponse;
import com.devoir.pokedex.pokedex.api.PokemonRetrofit;
import com.devoir.pokedex.pokedex.database.PokedexViewModel;
import com.devoir.pokedex.pokedex.database.pokeinfo.tables.Ability;
import com.devoir.pokedex.pokedex.database.pokeinfo.tables.PokeInfo;
import com.devoir.pokedex.pokedex.database.pokeinfo.tables.Pokemon_Favorite;
import com.devoir.pokedex.pokedex.database.pokeinfo.tables.Type;
import com.devoir.pokedex.pokedex.entities.Pokemon;
import com.devoir.pokedex.pokedex.entities.PokemonInfo;
import com.devoir.pokedex.recyclerview.adapter.PokemonAbilityAdapter;
import com.devoir.pokedex.recyclerview.adapter.PokemonTypeAdapter;
import com.devoir.pokedex.util.ColorUtil;
import com.devoir.pokedex.util.ConstantUtil;
import com.devoir.pokedex.util.FormatUtil;
...
public class InfoPokemonActivity extends AppCompatActivity {
    ...
    private PokemonInfo setPokemonInfo(Response<PokemonInfo> response) {
        ...
        String pesoAltura = "Poids: " + FormatUtil.formatMedida(body.getWeight(), "kg")
                + " - Hauteur: " + FormatUtil.formatMedida(body.getHeight(), "m");
    ...
    private void setInfoFromDatabase(PokeInfo info) {
        try {
            String pesoAltura = "Poids: " + FormatUtil.formatMedida(info.getWeight(), "kg")
                    + " - Hauteur: " + FormatUtil.formatMedida(info.getHeight(), "m");
            pesoAlturaPokemon.setText(pesoAltura);
            ...
            Log.i("PokedexDB Null", "Donnée inexistante dans la base de données pour Pokémon " + nomePokemon.getText());
